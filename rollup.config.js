...
export default [
	{
		...
		external: external,
		plugins: [babel(babelOptions(false)), commonjs(cjsConf)],
	},
	{
		...
		globals: globals,
		external: external,
		plugins: [babel(babelOptions(false)), resolve(), commonjs(cjsConf)],
	},
	{
		input: 'src/index.umd.js',
		output: {
		...
		globals: globals,
		external: external,
		plugins: [babel(babelOptions(true)), resolve(), uglify({}, minify), commonjs(cjsConf)],
	},
];
