...
var Select = function (_React$Component) {
   ...
   */
		...
		key: 'renderOuter',
		value: function renderOuter(options, valueArray, focusedOption, isOpen) {
			var _this8 = this;
			...
			return _react2.default.createElement(
				_renderprops.Transition,
				{
					...
					config: _renderprops.config.stiff
				},
				function (isOpen) {
					return isOpen && function (props) {
						return _react2.default.createElement(
							_renderprops.animated.div,
							{
								...
								style: _extends({}, _this8.props.menuContainerStyle, props)
							},
							_react2.default.createElement(
								'div',
								{
									className: 'Select-menu',
									id: _this8._instancePrefix + '-list',
									onMouseDown: _this8.handleMouseDownOnMenu,
									onScroll: _this8.handleMenuScroll,
									ref: function ref(_ref4) {
										return _this8.menu = _ref4;
									},
									role: 'listbox',
									style: _this8.props.menuStyle,
									tabIndex: -1
								},
								menu
							)
